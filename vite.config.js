  ...
  build: {
    rollupOptions: {
      input: {
        ...
        geometrique: resolve(__dirname, 'background/geometrique/index.html'),
        atome: resolve(__dirname, 'background/atome/index.html'),
        meduse: resolve(__dirname, 'background/meduse/index.html'),
      },
    },
  },
})